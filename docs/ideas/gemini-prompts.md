...
Copy and paste these exact prompts into Gemini/Imagen. *Pro-tip for Gemini: If it generates something too colorful, explicitly add "Use absolutely no colors other than white, black, and [Accent Color]." to the prompt.*
