/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a7f30dd23f9b0348d9a1867c51eb647)
// Runtime types generated with workerd@1.20260426.1 2026-04-29 nodejs_als
declare namespace Cloudflare {
	interface Env {
		PUBLIC_SUPABASE_URL: string;
		PUBLIC_SUPABASE_ANON_KEY: string;
		PUBLIC_ADMIN_PASSWORD: string;
		PUBLIC_PHONE_ADE_IRFAN: string;
		PUBLIC_WHATSAPP_ADE_IRFAN: string;
		PUBLIC_PHONE_NESYA: string;
		PUBLIC_WHATSAPP_NESYA: string;
		PUBLIC_PHONE_NANI: string;
		PUBLIC_WHATSAPP_NANI: string;
	}
}
